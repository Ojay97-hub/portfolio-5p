            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">HTML/CSS</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">JavaScript</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Python</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Django</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">PostgreSQL</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Bootstrap</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Git/GitHub</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">React</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Tailwind CSS</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Stripe API</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Azure</span>
                  </div>
                  <div className="bg-gray-700 hover:bg-gray-600 transition-all p-4 md:p-6 rounded-xl text-center transform hover:scale-105">
                    <span className="text-md sm:text-lg font-medium">Agile</span>
                  </div>
                </div>
